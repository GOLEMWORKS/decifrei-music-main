...
header.innerHTML = 
    ...
    <nav id='nav'>
        ...
        <ul>
            ...
            <a href='cursos.html'><li>Курсы</li></a>
            <a href='https://forms.gle/tMkNdSbadG54h25i8' target='_blank'><li>Наши уроки</li></a>
            <a href='#sobre'><li>О нас</li></a>
            <a href='loja.html'><li>Мероприятия</li></a>
        </ul>
    </nav>`;
